...
<div class="hidden md:block">
    ...
    <section class="pt-36 pb-20 bg-white text-center fade-soft">
        <div class="max-w-3xl mx-auto px-6">
            <h1
                class="hero-title leading-tight font-extrabold text-[2.8rem] md:text-[3.6rem]"
            >
            ...
            <p
                class="mt-5 text-gray-600 text-lg leading-relaxed max-w-2xl mx-auto"
            >
                Solusi percetakan modern yang menggabungkan teknologi, estetika,
                dan konsistensi untuk menghadirkan hasil terbaik bagi bisnis
                Anda.
            </p>

            <div
                class="w-28 h-1 mx-auto mt-6 rounded-full"
                style="
    ...
    <section class="py-24 bg-[#fafafa]">
        <div
            class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-14 items-center"
        >
            {{-- LEFT – TEXT --}}
            <div class="fade-soft">
                <h2
                    class="text-3xl font-bold text-[#0f0f0f] mb-3 border-l-4 pl-3"
                ...
                <p class="text-gray-600 leading-relaxed mb-3">
                    CV. Restu Guru Promosindo adalah perusahaan percetakan yang
                    berfokus pada kualitas, presisi, dan pelayanan profesional.
                </p>

                <p class="text-gray-600 leading-relaxed">
                    Dengan pengalaman bertahun-tahun di industri percetakan
                    modern, kami memahami bahwa setiap detail visual adalah
                    representasi penting dari identitas brand Anda.
                </p>
            </div>

            {{-- RIGHT – IMAGE (BARU DAN LEBIH PROFESIONAL) --}}
            <div class="soft-float">
                <img
                    src="{{ asset('images/siapa-kami.jpg') }}"
                    class="rounded-2xl shadow-xl object-cover w-full h-[380px] hover:scale-[1.02] transition duration-300"
                    alt="Tentang Restu Guru Promosindo"
                />
            </div>
        </div>
    </section>
        ...
        >
            ...
            <div class="fade-soft">
                ...
                <p class="text-gray-600 leading-relaxed mt-4">
                    Putra Qomaluddin Attar Nurriqli adalah pendiri sekaligus
                    Direktur CV. Restu Guru Promosindo.
                </p>

                <p class="text-gray-600 leading-relaxed mt-3">
                    Dengan pengalaman komunikasi yang matang, beliau membangun
                    Restu Guru Promosindo sebagai percetakan modern dengan fokus
                    kualitas dan presisi.
                </p>

                <p class="text-gray-600 leading-relaxed mt-3">
                    Di bawah kepemimpinannya, perusahaan berkembang pesat dengan
                    hasil cetak yang konsisten & rapi.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-[#fafafa]">
        <div class="max-w-6xl mx-auto px-6 text-center">
            ...
            <p class="section-desc fade-soft">
            ...
            <div class="grid md:grid-cols-3 gap-12 mt-14">
                <div class="fade-soft hover:-translate-y-1 transition">
                    <h3 class="text-xl font-semibold text-[#0f0f0f]">
                        Quality First
                    </h3>
                    <div
                        class="w-10 h-1 mx-auto mt-2 rounded-full"
                ...
                <div class="fade-soft hover:-translate-y-1 transition">
                    ...
                    ></div>
                    <p class="text-gray-600 mt-3">
                        Presisi warna & detail profesional.
                    </p>
                </div>
    ...
    <section class="py-24 bg-white fade-soft">
        <div class="max-w-5xl mx-auto px-6">
            ...
            <p class="section-desc fade-soft">
                Perjalanan Restu Guru Promosindo.
            </p>

            <div
                class="relative border-l-4 mt-14 space-y-12"
            ...
            >
                <div class="ml-6">
                    ...
                    <p class="text-gray-600 mt-2">
                        Didirikan sebagai percetakan lokal.
                    </p>
                </div>
                ...
                <div class="ml-6">
                    ...
                    <p class="text-gray-600 mt-2">
                        Penambahan layanan indoor & outdoor.
                    </p>
                </div>
                ...
                <div class="ml-6">
                    ...
                    <p class="text-gray-600 mt-2">
                        Mengadopsi digital workflow modern.
                    </p>
                </div>
                ...
                <div class="ml-6">
                    ...
                    <p class="text-gray-600 mt-2">
                        Ekspansi ke Banjarbaru, Banjarmasin, Martapura, dll.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-white text-center fade-soft">
        ...
        <p class="text-gray-600 max-w-lg mx-auto mt-3">
            Kami siap mendukung kebutuhan percetakan Anda dengan hasil terbaik &
            presisi tinggi.
        </p>
...
<div class="block md:hidden">
    ...
    <section class="pt-28 pb-14 text-center px-6 fade-soft">
        ...
        <div
            class="w-24 h-[3px] mx-auto mt-5 rounded-full"
            style="background: var(--brand-blue)"
        ></div>
    </section>
    ...
    <section class="px-6 py-12 fade-soft">
        <img
            src="{{ asset('images/about-office.jpg') }}"
        ...
        <p class="text-gray-600 text-sm leading-relaxed">
            CV. Restu Guru Promosindo adalah perusahaan percetakan yang berfokus
            pada kualitas dan presisi.
        </p>
    </section>
    ...
    <section class="px-6 py-12 fade-soft">
        ...
        <p class="text-gray-600 text-sm mt-3 leading-relaxed">
            Pendiri sekaligus Direktur CV. Restu Guru Promosindo dengan
            pengalaman komunikasi & branding modern.
        </p>
    </section>
    ...
    <section class="px-6 py-12 fade-soft text-center">
        ...
        <div
            class="w-16 h-[3px] mx-auto mt-2 mb-8 rounded-full"
            style="background: var(--brand-yellow)"
        ></div>
    ...
    <section class="py-14 px-6 text-center fade-soft">
        <h2 class="text-xl font-bold text-[#0f0f0f]">
            Siap Bekerja Dengan Kami?
        </h2>

        <p class="text-gray-600 text-sm mt-2 max-w-xs mx-auto">
            Kami siap mendukung kebutuhan percetakan Anda dengan pelayanan
            profesional.
        </p>

        <a
            href="{{ route('contact') }}"
            class="btn-primary mt-6 inline-block px-10 py-3 text-sm"
        >
            Hubungi Kami
        </a>
    </section>
